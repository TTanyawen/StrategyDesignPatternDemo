...
@Slf4j
@Service
public final class Discount95Handler extends AbstractDiscountHandler implements AbstractExecuteStrategy<DiscountReq, DiscountResp> {
    ...
    public DiscountResp discount(DiscountReq req) {
        ...
        resp.setPrice(req.getPrice()*0.95);
        return resp;
    }
    @Override
